...
.PARAMETER Clean
Removes the image webapi.core and kills all containers based on that image.
...
Build a Docker image named webapi.core
#>
...
$imageName="webapi.core"
$projectName="webapicore"
